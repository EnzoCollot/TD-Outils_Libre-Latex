...
\begin{center}
  \includegraphics[width=10cm]{Commande.png}
\end{center}
...
\begin{center}
  \includegraphics[width=10cm]{HISTIGNORE.png}
\end{center}
...
\begin{figure}[h]
  ...
  \begin{subfigure}{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{commande_test.png}
...
\begin{center}
  \includegraphics[width=7cm]{Sevices.png}
\end{center}
...
\begin{center}
  \includegraphics[width=7cm]{fonction\_zsh.png}
\end{center}
...
\begin{center}
  \includegraphics[width=7cm]{bindkey.png}
\end{center}
