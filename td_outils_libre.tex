...
\begin{itemize}
  \item Purger le fichier ~/.ssh/known_hosts si nécessaire ?
\end{itemize}
...
\texttt{ssh-keyscan 10.0.0.3 >> ~/.ssh/known_hosts}
...
\texttt{ssh-copy-id -i ~/.ssh/id_rsa.pub user@srv} 
